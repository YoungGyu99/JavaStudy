 ...
 * */
		...
		if (menu == 1) {
			...
			productCount++; // 입력이 완료 되었을때 그 다음 배열로 넘어감 
		} else if (menu == 2) {
			if (productCount == 0) {
