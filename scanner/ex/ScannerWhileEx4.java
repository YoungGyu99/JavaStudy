...
public class ScannerWhileEx4 {
	...
	public static void main(String[] args) {
		/*문제 - 상품 구매
		 * - 상요자로부터 상품 정보(상품명, 가격, 수량)을 입력받고, 이들의 총 가격을 출력하는 프로그램을 작성하세요. 사용자는 여러 상품을 추가하고 결제할 수 있으며, 
		 * 프로그램을 언제든지 종료할 수 있습니다.
		 * - 사용자에게 다음 세 가지 옵션을 제공해야 합니다: 1:상품 입력, 2:결제, 3:프로그램 종료. 옵션은 정수로 입력받으며, 옵션을 저장한느 변수의 일므은 option이어야합니다.
		 * - 상품 입력 옵션을 선택하면, 사용자에게 상품명과 가격, 수량을 입력받으세요.
		 * - 결제 옵션을 선택하면, 총 비용을 출력하고 총 비용을 0으로 초기화하세요. (사용자가 총 비용을 확인하고, 결제를 완려했다고 가정합니다. 따라서 다음 사용자를 위해 총 비용을 
		 * 다시 0으로 초기화 해야합니다.)
