...
public class Summary {
	...
	public static void main(String[] args) {
		 ...
		 * 2. 정해진 횟수만큼의 반복을 수행하는 경우에 사용하기 적합합다.
		 * 3. 루프 변수의 범위가 for 루프 블록에 제한되므로, 다른 곳에서 이 변수를 실수로 변경할 가능성이 적다.
		 * 
		 * 단점:
		 * 1. 루프의 조건이 루프 내부에서 변경되는 경우, for르프는 관리하기 어렵다.
		 ...
		 * 
		 * 한줄로 정리하자면 정해진 횟수만큼 반복수행해야 하면 for문을 사용하고 그렇지 않으면 while문을 사용하면 된다. 물론 이것도 항상 정답은 아니니 기준으로 삼는 정도로 이해하자
		 * */
